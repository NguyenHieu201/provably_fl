...
# TODO: load file with new test sigma
def main():
    ...
    # server.run()
    model_path = "/mnt/disk1/tiennh/provably_fl/fedtask/cifar10_cnum100_dist2_skew0.5_seed0/record/fedprob_N_0.5Mresnet18_R200_B10_E5_LR0.0500_P0.10_S0_LD-0.002_WD0.000_DR0.00_AC99999.00.json.pkl"
    print("Load model")
    model = pk.load(open(model_path, "rb"))
    # certify
    server.model = model
    server.log_certify()
    logger.save(filepath="./load_model/test.json")
