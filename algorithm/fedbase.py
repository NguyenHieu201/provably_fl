...
class BasicClient():
    ...
    def test(self, model: nn.Module, dataflag='valid'):
        """
    ...
    def unpack(self, received_pkg: ServerPackage):
        """
    ...
    def reply(self, svr_pkg: ServerPackage) -> ClientPackage:
        """
    ...
    def pack(self, model: nn.Module, loss: float) -> ClientPackage:
        """
    ...
    def train_loss(self, model: nn.Module) -> float:
        """
    ...
    def valid_loss(self, model: nn.Module) -> float:
        """
    ...
    def set_learning_rate(self, lr: float = 0.0):
        """
...
class BasicServer():
    ...
    def communicate_with(self, client_id: int):
        """
    ...
    def global_lr_scheduler(self, current_round: int):
        """
    ...
    def test_on_clients(self, round: int, dataflag='valid'):
        """
